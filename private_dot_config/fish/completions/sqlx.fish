...
complete -c sqlx -n "__fish_sqlx_using_subcommand database; and __fish_seen_subcommand_from create" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand database; and __fish_seen_subcommand_from drop" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand database; and __fish_seen_subcommand_from reset" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand database; and __fish_seen_subcommand_from setup" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand prepare" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand migrate; and __fish_seen_subcommand_from run" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand migrate; and __fish_seen_subcommand_from revert" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
...
complete -c sqlx -n "__fish_sqlx_using_subcommand migrate; and __fish_seen_subcommand_from info" -l sqlite-create-db-wal -d 'Set whether or not to create SQLite databases in Write-Ahead Log (WAL) mode: https://www.sqlite.org/wal.html' -r -f -a "{true\t'',false\t''}"
